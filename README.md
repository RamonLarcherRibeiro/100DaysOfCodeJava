...
| `61` | `Filtrar Lista com Condições` |`Dada uma lista de objetos Pessoa, crie um método que retorna apenas as pessoas com idade maior que 18, usando um loop for.	` |